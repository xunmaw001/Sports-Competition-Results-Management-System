...
public class CaipanyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CaipanyuanEntity user = caipanyuanService.selectOne(new EntityWrapper<CaipanyuanEntity>().eq("caipanyuanzhanghao", username));
    ...
    public R register(@RequestBody CaipanyuanEntity caipanyuan){
    	...
    	CaipanyuanEntity user = caipanyuanService.selectOne(new EntityWrapper<CaipanyuanEntity>().eq("caipanyuanzhanghao", caipanyuan.getCaipanyuanzhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CaipanyuanEntity caipanyuan, HttpServletRequest request){
