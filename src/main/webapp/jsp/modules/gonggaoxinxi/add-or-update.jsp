...
<body>
	...
	<script>
		...
		var gonggaoleixingOptions = [];

				function gonggaoleixingSelect(){
					http("option/gonggaoleixing/gonggaoleixing","GET",{},(res)=>{
						if(res.code == 0){
							gonggaoleixingOptions = res.data;
							var nullOption = document.createElement('option');
							var gonggaoleixingSelect = document.getElementById('gonggaoleixingSelect');
							gonggaoleixingSelect.appendChild(nullOption);
							for(var i=0;i<gonggaoleixingOptions.length;i++){
								var gonggaoleixingOption = document.createElement('option');
								gonggaoleixingOption.setAttribute('name','gonggaoleixingOption');
								gonggaoleixingOption.setAttribute('value',gonggaoleixingOptions[i]);
								gonggaoleixingOption.innerHTML = gonggaoleixingOptions[i];									
								if(ruleForm.gonggaoleixing == gonggaoleixingOptions[i]){
									gonggaoleixingOption.setAttribute('selected','selected');
								}
								gonggaoleixingSelect.appendChild(gonggaoleixingOption);
							}
						}
					});
				}	
